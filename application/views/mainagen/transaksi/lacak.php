        ...
        <div class="card-body">
            ...
            <ul class="events">
                <?php foreach ($lacak as $lacak) : ?>
                    <li>
                        <time class="col-6 text-right" datetime="10:03"><?php echo tanggal_indonesia_lengkap(date('Y-m-d', $lacak->date_updated)); ?><br> <?php echo date('H:i:s', $lacak->date_updated); ?> WIB</time>
