<button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#Edit<?php echo $transaksi->id; ?>">
    <i class="fa fa-edit"></i> Ambil Dari Counter
</button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                echo form_open(base_url('mainagen/transaksi/ambil/' . $transaksi->id));

                ?>

                Paket Akan di kirim ke Kota <?php echo $transaksi->kota_name; ?> - <?php echo $transaksi->provinsi_name; ?>

                <input type="hidden" name="status" value="Di Ambil Oleh <?php echo $transaksi->kota_name; ?>">
