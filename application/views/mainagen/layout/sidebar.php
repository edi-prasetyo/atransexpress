...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  <!-- Brand Logo -->
  <a href="<?php echo base_url('mainagen/dashboard'); ?>" class="brand-link">
  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <a href="<?php echo base_url(); ?>mainagen/dashboard" class="nav-link">
        ...
        <li class="nav-item">
          <a href="<?php echo base_url(); ?>mainagen/transaksi/kirim" class="nav-link">
        ...
        <li class="nav-item">
          <a href="<?php echo base_url(); ?>mainagen/transaksi/riwayat" class="nav-link">
        ...
        <li class="nav-item">
          <a href="<?php echo base_url(); ?>mainagen/kurir" class="nav-link">
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="<?php echo base_url('mainagen/profile'); ?>" class="nav-link">
