    ...
    <div class="col-md-5 mx-auto">
        ...
        <div class="card card-primary card-outline">
            <div class="card-body box-profile">
                ...
                <div class="row">
                    <div class="col-6">
                        <a href="<?php echo base_url('mainagen/profile/update'); ?>" class="btn btn-primary btn-block"><b>Ubah Data</b></a>
                    </div>
                    <div class="col-6">
                        <a href="<?php echo base_url('mainagen/profile/password'); ?>" class="btn btn-info btn-block"><b>Ubah Password</b></a>
                    </div>
                </div>
            </div>
            <!-- /.card-body -->
