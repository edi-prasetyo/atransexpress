        ...
        <div class="card card-info">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <input type="hidden" value="<?php echo $user->provinsi_name; ?>" name="provinsi_id">
                    <input type="text" value="<?php echo $destinasi->kota_asal; ?>" name="kota_id" readonly>
                    <input type="text" value="<?php echo $destinasi->kota_tujuan; ?>" name="kota_id" readonly>
                    <div class="col-md-12">
