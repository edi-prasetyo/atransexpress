...
class Withdraw_model extends CI_Model
{
    ...
    {
        $this->db->select('withdraw.*, user.name, user_code');
        $this->db->from('withdraw');
        // join
        $this->db->join('user', 'user.id = withdraw.user_id', 'LEFT');
        // End Join
    ...
    {
        $this->db->select('withdraw.*, user.name, user_code, user.user_phone, user.email,user.bank_name,user.bank_number, user.bank_account, user.bank_branch');
        $this->db->from('withdraw');
        // join
        $this->db->join('user', 'user.id = withdraw.user_id', 'LEFT');
        // End Join
    ...
    // All Withdraw User
    public function get_allmy_withdraw($user_id)
    {
        $this->db->select('*');
        $this->db->from('withdraw');
